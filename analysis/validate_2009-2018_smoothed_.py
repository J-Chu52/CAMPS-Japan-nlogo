...
# ===== 区分"长周期理论数据"(图1三联图用, tick 3-200) 和 "历史窗口数据"(tick 1-40,
# 图2/图3/拟合统计用)。与 validate_1994-2003_smoothed.py 保持一致的口径。 =====
THEORY_TICK_MIN = 2     # 图1三联图起点(不含) -> 实际从 tick 3 开始
...
# ============================================================
# 图1: 理论验证三联图 (使用 tick 3-200 的长周期数据)
# ============================================================
