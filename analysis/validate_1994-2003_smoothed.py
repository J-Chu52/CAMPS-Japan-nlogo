...
fig2.tight_layout()
fig2.savefig(f'{OUT_DIR}/fig07_insample_fit_1994-2003.png', dpi=600, bbox_inches='tight')
print('✓ 图2 (主图, 4Q MA)')
...
fig2r.tight_layout()
fig2r.savefig(f'{OUT_DIR}/si_fig07_insample_fit_raw.png', dpi=600, bbox_inches='tight')
print('✓ 图2附录 (raw, 备查)')
...
fig3.tight_layout()
fig3.savefig(f'{OUT_DIR}/fig08_financial_1994-2003.png', dpi=600, bbox_inches='tight')
print('✓ 图3')
...
fig_es.tight_layout()
fig_es.savefig(f'{OUT_DIR}/legacy_oat_count_shift_effect.png', dpi=600, bbox_inches='tight')
