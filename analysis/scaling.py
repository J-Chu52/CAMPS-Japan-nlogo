...
fig1.suptitle('Scale invariance of emergent indicators\n'
              ...
              fontsize=12, y=1.00)
fig1.tight_layout()
fig1.savefig(OUT_571, dpi=600, bbox_inches='tight', facecolor='white')
...
fig2.suptitle('Statistical scaling of variance and linear scaling of totals',
              fontsize=12, y=1.00)
fig2.tight_layout()
fig2.savefig(OUT_572, dpi=600, bbox_inches='tight', facecolor='white')
...
fig3.suptitle('Trajectory overlap across n* (4-quarter smoothed; band = ±1σ)',
              fontsize=12, y=1.00)
fig3.tight_layout()
fig3.savefig(OUT_573, dpi=600, bbox_inches='tight', facecolor='white')
